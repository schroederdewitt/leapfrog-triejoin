...
bool leapFrogTrieJoin_TEST(){
	...
	//string string2[] = {"myfile","-query","../../../docs/datasets/query1","-database","../../../docs/datasets/dataset1-uniform/scale6/databasefile"};
	//string string2[] = {"myfile","-query","../../../docs/datasets/query1","-database","../../../docs/datasets/dataset2-zipf/scale1/databasefile"};
	...
	string string2[] = {"myfile","-query","../../../docs/datasets/query3","-database","../../../docs/datasets/dataset1-uniform/scale6/databasefile"};
	//string string2[] = {"myfile","-query","../../../docs/datasets/query3","-database","../../../docs/datasets/dataset2-zipf/scale6/databasefile"};
	if(j->Open(5, string2, error) == OK) cout<<"Test passed."<<endl;
	else cerr << error<<endl;
	if(merge->Open(j, error) == OK) cout<<"Test passed."<<endl;	
	else cerr<<error<<endl;

	if(merge->Join(error) == OK) cout<<"Test passed."<<endl;
	else cerr<<error<<endl;
	
	cout<<"Nr of Join results: "<<merge->NrJoinResults<<endl;
